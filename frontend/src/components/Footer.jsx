  ...
  return (
    <div>
      <div className="flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm">
        ...
        <div>
          <p className="poppins-regular text-x1 font-bold mb-5">ŞİRKET</p>
        ...
        <div>
          <p className="poppins-regular text-x1 font-bold mb-5">BİZE ULAŞIN</p>
          <ul className="poppins-regular flex flex-col gap-1 text-gray-600">
            <li>222-22-222</li>
      ...
      <div>
        <hr />
        <p className="prompt-bold py-5 text-sm text-center">
